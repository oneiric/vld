################################################################################
#  $Id: vld-setup.nsi,v 1.1 2006/10/31 05:04:22 dmouldin Exp $
...
Section "Dynamic Link Library"
	!insertmacro InstallLib DLL NOTSHARED NOREBOOT_NOTPROTECTED "..\Release\vld.dll" "$SYSDIR\vld.dll" $INSTDIR
SectionEnd
...
Section "un.Dynamic Link Library"
	!insertmacro UnInstallLib DLL NOTSHARED NOREBOOT_NOTPROTECTED $SYSDIR\vld.dll
SectionEnd
